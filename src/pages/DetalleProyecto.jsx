    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <p className="font-bold text-[#17243D]">Autor</p>
            <p>{proyecto.autor}</p>
          </div>

          <div>
            <p className="font-bold text-[#17243D]">Tutor</p>
            <p>{proyecto.tutor}</p>
          </div>

          <div>
            <p className="font-bold text-[#17243D]">Carrera</p>
            <p>{proyecto.carrera}</p>
          </div>

          <div>
            <p className="font-bold text-[#17243D]">Periodo</p>
