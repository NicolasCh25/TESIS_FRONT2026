...
import { MdPerson, MdEmail, MdLock, MdSchool, MdVisibility, MdVisibilityOff } from "react-icons/md";
...
const FormularioRegistroPublico = ({ onSubmit, cargando }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      {/* Password con Ojo y Validación de Complejidad */}
      <div className="relative">
        <span className="absolute inset-y-0 left-4 flex items-center text-gray-400">
          <MdLock size={20} />
        </span>
        ...
        <button
          ...
          className="absolute inset-y-0 right-4 flex items-center text-gray-400 hover:text-[#17243D] transition-colors"
        >
